...
#define CMD_CODE_LEN 2
        ...
        QuietCool::QuietCool(uint8_t csn, uint8_t gdo0, uint8_t gdo2, uint8_t sck, uint8_t miso, uint8_t mosi, const uint8_t *remote_id_in, float center_freq, float deviation_khz) : csn_pin(csn),
                                                                                                                                                                                      gdo0_pin(gdo0),
                                                                                                                                                                                      gdo2_pin(gdo2),
                                                                                                                                                                                      sck_pin(sck),
                                                                                                                                                                                      miso_pin(miso),
        ...
        void QuietCool::processPacket(const uint8_t *packet, size_t packet_len, uint32_t timestamp_ms)
        {
            ...
            else
            {
                ...
                {
                    if (offset == 7)
                        continue; // Already checked offset 7
